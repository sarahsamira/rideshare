            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card-box">
                                <h4 class="header-title m-t-0 m-b-30">Deletes Role</h4>
                                <div class="row">
                                    <div class="col-md-12">
                                        <button @click.prevent="deleteRole" class="btn btn-lg btn-block btn-danger"><i class="fa fa-trash"></i>Delete</button>
                                    </div>
                        ...
                        <div class="col-md-8">
                            <div class="card-box">
                                <h4 class="header-title m-t-0 m-b-30">Edit Role</h4>
                                <hr>
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <button @click="roleAdd" type="button" class="btn btn-primary btn-block btn-lg"><i class="fa fa-save"></i>&nbsp;Save role</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        methods: {
            deleteRole(){
                this.$confirm("Are you sure to delete the role?","Warning","warning").then(() => {
                    this.$inertia.delete('/admins/admin-roles/'+this.id).then(()=>{
                        //
                    });
                });
            },
            ...
            roleAdd: function () {
                if (this.roleForm.name === '' || this.roleForm.slug === '') {
                    ...
                    this.$inertia.put('/admins/admin-roles/'+this.roleForm.id,this.roleForm).then(()=>{
                        //
                    })
                }

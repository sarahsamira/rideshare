...
<div>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-dark">
            ...
            <tr>
                ...
                <th scope="col" style="width: 100px;vertical-align: middle">Slug</th>
            ...
            <tr v-for="permission in permissionOutput.data" :key="permission.id">
                ...
                <td style="vertical-align: middle">{{permission.slug}}</td>
                <td style="vertical-align: middle">
                    ...
                    &nbsp;<inertia-link :href="'/admins/admin-roles/'+permission.id+'/edit'" class="text-warning" data-toggle="tooltip" data-placement="top" title="Edit info"><i class="fa fa-pencil"></i></inertia-link>
                </td>
            </tr>
            </tbody>
        </table>
    ...
    <!-- Modal -->
    <div class="modal fade" id="exampleModalsRole" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script>
    export default {
        ...
        methods: {
            deletePermission(id){
                this.$confirm("Are you sure to delete the role?","Warning","warning").then(() => {
                    this.$inertia.delete('/admins/admin-roles/'+id,{
                        replace: false,
                        preserveState: true,
                        preserveScroll: true,
                        only: [],
            ...
            multipleDelete() {
                this.$confirm("Are you sure to delete the roles?","Warning","warning").then(() => {
                    if (this.checkedValues.length > 0){
                        this.$inertia.delete('/admins/admin-roles/multiple/' + this.checkedValues, {
                            replace: false,
                            preserveState: true,
            ...
            allDelete(){
                this.$confirm("Are you sure to delete all roles?","Warning","warning").then(() => {
                    this.$inertia.post('/admins/admin-roles/delete-all',{
                        replace: false,
                        preserveState: true,
                        preserveScroll: true,
                        only: [],
